...
const parent = React.createElement("div", { id: "parent" }, [
  ...
  React.createElement("div", { id: "child" }, [
    React.createElement("h1", { id: "child" }, "I am child three sdjkfnsdjk"),
...
/// most import package is bundler - webpack ,parcel ,vite etx
 ...
 *
 *  ^ 'carat' and ~ 'tilde' these two have different
 * meaning in the package json
 * 1. ^ carat -  it is always safe to use carat as it only updates
 *    minor versions changes
 *
 * 2. ~ tilde - it updates major versions changes
 *
 *
